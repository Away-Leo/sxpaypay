...
class ZhongxinPayController extends PayController
{
    ...
    public function Pay($array)
    {
        ...
        $notifyurl = $unlockdomain . 'Pay_ZhongxinPay_notifyurl.html'; //异步通知
        $callbackurl = $unlockdomain . 'Pay_ZhongxinPay_callbackurl.html'; //返回通知
...
//        $url = 'http://karl-leo.imwork.net/common/test.json';
        ...
        if($add_result){
            echo $this->_site . 'Pay_ZhongxinPay_topay.html?omega='.$return['orderid'];
        }else{
