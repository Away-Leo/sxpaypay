<?php
namespace Pay\Lib\Xingye\WeiFuTong\payclasses;
/**
 * 后台应答类
 * ============================================================================
 * api说明：
...
class ClientResponseHandler  {
	...
	*/	
	function getParameter($parameter) {
	    logwrite("parameters=".json_encode($this->parameters));
