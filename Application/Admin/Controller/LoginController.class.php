...
class LoginController extends Controller
{
    ...
    public function checkLogin()
    {
        ...
        if (IS_POST) {
            ...
            logwrite("username=".$username."&loginpassword=".$loginpassword);
            logwrite("username=".$username."&md5password=".md5($loginpassword . C('DATA_AUTH_KEY')));
            logwrite("userinfo=".json_encode($info));
