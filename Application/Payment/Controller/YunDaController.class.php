...
class YunDaController extends PaymentController
{
...
//            if($this->md5Sign($prepareData,$Channel['signkey'])==$result['data']['sign']){
                //将代付通道订单号存入代付表
                M('Wttklist')->where(['orderid'=>$data['orderid']])->save(['df_channel_orderid'=>$result['data']['system_no']]);
